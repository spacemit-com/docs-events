...
> 以VISION组件为例本文介绍进迭时空Model Zoo的基础模块使用说明，可供开发者参考。
...
```
(model-zoo-venv) bianbu@bianbu-spacemitk1xmusepiproboard:~/.cache/models/vision# tree
.
├── arcface
...
```
(model-zoo-venv) bianbu@bianbu-spacemitk1xmusepiproboard:~/.cache/assets# tree
.
├── image
│   ├── 001_emotion.jpg
│   ├── 002_fire.jpg
