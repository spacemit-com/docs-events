...
下载源码压缩包：[digit_demo.zip](https://cdn-resource.spacemit.com/file/event/digit_demo.zip)

> digit_demo.zip 仅支持识别数字和字母，若需识别文字，使用 [ocr_demo.zip](https://cdn-resource.spacemit.com/file/event/ocr_demo.zip)。
