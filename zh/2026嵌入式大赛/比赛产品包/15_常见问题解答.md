...
参考bianbu robot的 [tts demo](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/ros/05_AI_Feature_Experience/5.1_quickly_start/5.1.5_Text_to_Speech.md)
...
A：我们这边（在板子本地、没有通过SSH）测试运行很流畅，没有出现卡机状况。请确保舵机和ASR单独测试通过，参考：1. [外设模块参考说明](./04_外设模块参考说明.md) 2. [ASR](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/ros/05_AI_Feature_Experience/5.1_quickly_start/5.1.2_Speech_to_Text.md)
...
A：请确保：1. 串口线连接正确；2. mobaxterm的时候确保串口波特率和设备号设置正确。可以参考[ Bianbu Robot官方文档](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/ros/01_Quick_start/1.4_Remote_Access.md)。
...
A：参考 [Bianbu Robot NLP使用](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/ros/05_AI_Feature_Experience/5.1_quickly_start/5.1.1_Voice_Activity_Detection.md)
...
[进迭开发者社区 - 开发文档](https://www.spacemit.com/community/document/info?lang=zh&nodepath=hardware/eco/k1_muse_pi_pro/pi_pro_user_guide.md)
...
A：参考论坛解决方案：https://forum.spacemit.com/t/topic/823
