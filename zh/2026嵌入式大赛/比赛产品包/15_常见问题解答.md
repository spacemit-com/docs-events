...
K1不是GPU推理。电脑上训练完导出onnx模型，然后做量化。按照我们的教程 [ONNX Runtime使用指南](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/bianbu/ai/onnxruntime.md) 就可以推理，你自己电脑上做的gpu模型可能在k1上跑不起来。
