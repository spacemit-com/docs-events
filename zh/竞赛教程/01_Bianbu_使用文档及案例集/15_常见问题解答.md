...
在进迭时空的RISC-V架构开发环境中，推荐使用系统自带的venv工具创建Python虚拟环境，而非Anaconda。如果需要管理不同的python版本，推荐使用pyenv工具，具体使用参考：[Python 用户指南](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/bianbu/development/python.md)

## 4. 自主训练的模型能否部署到k1运行？

K1不是GPU推理。电脑上训练完导出onnx模型，然后做量化。按照我们的教程 [ONNX Runtime使用指南](https://www.spacemit.com/community/document/info?lang=zh&nodepath=courses/AI/01_AI%E5%9F%BA%E7%A1%80%E5%AD%A6%E4%B9%A0%E5%8F%8A%E5%AE%9E%E8%B7%B5/06_onnxruntime%E5%9F%BA%E6%9C%AC%E7%94%A8%E6%B3%95%E4%BB%8B%E7%BB%8D.md) 就可以推理，你自己电脑上做的gpu模型可能在k1上跑不起来。
...
参考Bianbu robot的 [tts demo](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/ros/k1/05_AI_Feature_Experience/5.1_quickly_start/5.1.5_Text_to_Speech.md)
...
A：我们这边（在板子本地、没有通过SSH）测试运行很流畅，没有出现卡机状况。请确保舵机和ASR单独测试通过，参考：1. [外设模块参考说明](./04_外设模块参考说明.md) 2. [ASR](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/ros/k1/05_AI_Feature_Experience/5.1_quickly_start/5.1.2_Speech_to_Text.md)
...
A：请确保：1. 串口线连接正确；2. mobaxterm的时候确保串口波特率和设备号设置正确。可以参考[ Bianbu Robot官方文档](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/ros/k1/01_Quick_start/1.4_Remote_Access.md)。
...
A：参考 [Bianbu Robot NLP使用](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/ros/k1/05_AI_Feature_Experience/5.1_quickly_start/5.1.1_Voice_Activity_Detection.md)
...
Q：能否补充一个通过sd卡启动，然后挂载访问系统硬盘的方法，主要解决有队伍无意间造成板卡无法启动，但是资料都在内部emmc里面，可以i通过这个方法先救资料和代码，然后顺带修复。

A：参考[论坛解决方案]https://forum.spacemit.com/t/topic/823

## 25. MIPI摄像头开发指南

Q：是否有mipi摄像头开发指南？

A：参考：（1）[Camera 快速点亮导览](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/buildroot/k1_buildroot/camera/camera_development_guide.md)  （2）[MIPI相机开发指南](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/ros/k1/03_Basic_applications/3.1_Image_Capture_and_Applications/3.1.1_Using_MIPI_Camera.md)